...
function createFolderRow(content, folderTitle){
    ...
    folderRow.style.backgroundColor = (conf[folderTitle].indexOf(content) % 2 === 1) ? 'lightgrey' : '#ffffff';
...
function openWindow(type, title, parent) {
